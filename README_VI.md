...
java --add-opens=java.base/java.nio=ALL-UNNAMED \
  -jar build/libs/dist-2.15.3.jar sim \
...
```bash
java --add-opens=java.base/java.nio=ALL-UNNAMED \
  -jar build/libs/dist-2.15.3.jar simple-run \
  --matsim-cfg data/config/matsim_config.xml
```
...
```bash
java --add-opens=java.base/java.nio=ALL-UNNAMED \
  -jar build/libs/dist-2.15.3.jar analysis \
  --cfg data/config/config.yaml \
  --matsim-cfg data/config/matsim_config.xml \
...
```bash
java --add-opens=java.base/java.nio=ALL-UNNAMED \
  -jar build/libs/dist-2.15.3.jar arrow \
...
COPY build/libs/dist-2.15.3.jar app.jar
