...
Một pipeline xử lý và tính điểm hiệu năng xe buýt sử dụng Kotlin, tích hợp trực tiếp với mô phỏng MATSim. Hệ thống sử dụng Apache Arrow để tối ưu lưu trữ, DuckDB cho xử lý dữ liệu quy mô lớn, và bộ chỉ số KPI theo tiêu chuẩn TCRP.
